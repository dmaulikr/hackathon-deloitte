...
struct Storyboards {
    ...
    struct Main: Storyboard {
        ...
        static func instantiateViewController() -> ViewController {
            return self.storyboard.instantiateViewController(withIdentifier: "ViewController") as! ViewController
        }

        static func instantiateCardViewController() -> CardViewController {
...
//MARK: - ViewController
extension ViewController: IdentifiableProtocol { 
    var storyboardIdentifier: String? { return "ViewController" }
    static var storyboardIdentifier: String? { return "ViewController" }
}


//MARK: - CardViewController
extension CardViewController: IdentifiableProtocol { 
    var storyboardIdentifier: String? { return "CardViewController" }
    static var storyboardIdentifier: String? { return "CardViewController" }
}
